            ...
            <div className="max-w-5xl mx-auto bg-white rounded-lg border border-gray-300 overflow-hidden">
              ...
              <div className="p-6 md:p-8">
                ...
                <div className="flex flex-wrap items-center gap-3 text-sm sm:text-base text-gray-500 mb-6">
                  ...
                  <div className="flex items-center gap-1">
                    <FaCalendarAlt className="text-emerald-600 text-xs sm:text-sm" />
                    <span>{blog.date}</span>
                  </div>
                  <div className="flex items-center gap-1">
                    <FaComment className="text-emerald-600 text-xs sm:text-sm" />
                    <span>{blog.comments} comments</span>
                  </div>
                  <div className="flex items-center gap-1">
                    <FaHeart className="text-emerald-600 text-xs sm:text-sm" />
